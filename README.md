...
ZooKage supports the following combinations. Every image has the postfix `-zookage-0.2`, e.g. `3.3.1-zookage-0.2`.
...
| 3.2.2 | 3.1.2-guava-27.0-jre | 0.9.2-guava-27.0-jre-jersey-1.19-servlet-api-3.1.0-without-jetty | 3.4.1 | 3.6.2 | 2.4.1 | 1.3.0 | 413 |
